...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, TuiRoot, TuiButton, TuiHeader, TuiAppearance, TuiTitle, TuiIcon, ProjectsComponent, AboutComponent, ExperienceComponent, P5SketchComponent],
